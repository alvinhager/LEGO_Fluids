...
namespace VectorMath
{
    ...
    public:
        ...
        CUDA_CALLABLE_MEMBER vec3(float x, float y, float z);
        CUDA_CALLABLE_MEMBER ~vec3();
    ...
    CUDA_CALLABLE_MEMBER vec3 operator-(const vec3 &v1, const vec3 &v2);
    vec3 operator-(const VectorMath::vec3 &v1, const float n);
    vec3 &operator-=(vec3 &v1, const vec3 &v2);
    ...
    public:
        ...
        mat3 negate();
        vec3 get(int i);
        CUDA_CALLABLE_MEMBER vec3 operator[](int i);
        mat3 transpose();
